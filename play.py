...
from utils import encode_images_to_latents, decode_latents_to_images, epsilon_to_x0, v_to_x0
...
def load_checkpoint(ckpt_dir, device):
    ...
    saved_prediction_type = checkpoint.get('prediction_type')
    if saved_prediction_type is not None:
        cfg.prediction_type = saved_prediction_type
    ...
    if saved_prediction_type is not None:
        cfg_full.prediction_type = saved_prediction_type
